        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" method="POST"
                    action="{{ route('user.comment.store', [$ticket_detail->id]) }}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jobno" placeholder="Ticket ID" name="job"
