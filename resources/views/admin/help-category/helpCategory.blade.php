...
@section('title')
    @lang('title.super_admin_help_category')
@endsection
                                        ...
                                        <div class="card card-rounded">
                                            <div class="card-body">
                                                <div class="d-sm-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h4 class="card-title card-title-dash">Help Category Page</h4>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <!-- Edit Modal -->
                                                        @include('admin.component.addHelpCategory')
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="table-responsive">
                    <table id="order-listing" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>Help Category Name</th>
                                <th>User</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($helpCategory as $item)
                                <tr>
