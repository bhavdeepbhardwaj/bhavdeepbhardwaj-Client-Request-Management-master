                                        ...
                                        <div class="card card-rounded">
                                            <div class="card-body">
                                                <div class="d-sm-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h4 class="card-title card-title-dash">Hi Client:
                                                            {{ Auth::user()->name }}</h4>
                                                        <h5 class="card-subtitle card-subtitle-dash">
                                                            {{ Auth::user()->role }} Client Dashboard</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="statistics-details d-flex align-items-center justify-content-between">
                                    <div>
                                        <p class="statistics-title">Social Media</p>
                                        <h3 class="rate-percentage text-center">5</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">Retail Artwork</p>
                                        <h3 class="rate-percentage text-center">6</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">Website / NEXSTMALL</p>
                                        <h3 class="rate-percentage text-center">9</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">SEO</p>
                                        <h3 class="rate-percentage text-center">3</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">Print Ads / Outdoor</p>
                                        <h3 class="rate-percentage text-center">8</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">Content</p>
                                        <h3 class="rate-percentage text-center">32</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">Reporting</p>
                                        <h3 class="rate-percentage text-center">3</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>-0.5%</span>
                                        </p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">EDM</p>
                                        <h3 class="rate-percentage text-center">7</h3>
                                        {{-- <p class="text-success d-flex"><i class="mdi mdi-menu-up"></i><span>+0.1%</span></p> --}}
                                    </div>
                                    <div>
                                        <p class="statistics-title">3rd Party eCommerce</p>
                                        <h3 class="rate-percentage text-center">6</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p> --}}
                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Application Support</p>
                                        <h3 class="rate-percentage text-center">2</h3>
                                        {{-- <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span>+0.8%</span> --}}
                                        </p>
                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Video</p>
                                        <h3 class="rate-percentage text-center">68</h3>
                                        {{-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p> --}}
                                    </div>
                                    <div class="d-none d-md-block">
                                        <p class="statistics-title">Misc Work</p>
                                        <h3 class="rate-percentage text-center">35</h3>
                                        {{-- <p class="text-success d-flex"><i class="mdi mdi-menu-down"></i><span>+0.8%</span> --}}
                                        </p>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="mt-3">
                                                            <div
                                                                ...
                                                                <div class="d-flex">
                                                                    <img class="img-sm rounded-10"
                                                                        src="{{ asset('images/faces/face1.jpg') }}"
                                                                        alt="profile">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex">
                                                                    <img class="img-sm rounded-10"
                                                                        src="{{ asset('images/faces/face2.jpg') }}"
                                                                        alt="profile">
                                                                    <div class="wrapper ms-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex">
                                                                    <img class="img-sm rounded-10"
                                                                        src="{{ asset('images/faces/face3.jpg') }}"
                                                                        alt="profile">
                                                                    <div class="wrapper ms-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex">
                                                                    <img class="img-sm rounded-10"
                                                                        src="{{ asset('images/faces/face4.jpg') }}"
                                                                        alt="profile">
                                                                    <div class="wrapper ms-3">
