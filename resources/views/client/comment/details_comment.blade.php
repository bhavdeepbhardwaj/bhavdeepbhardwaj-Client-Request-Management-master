                                                ...
                                                <div class="d-sm-flex justify-content-between align-items-start">
                                                    <div>
                                                        <h4 class="card-title card-title-dash">SRN No:-
                                                            {{ Auth::user()->prefix }}{{ sprintf('%03d', intval($comment_record->id)) }}
                                                        </h4>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <!-- <div>
                                                                <h4 class="card-title card-title-dash text-center">Comments SRN No:- {{ $comment_record->job }}{{ $num = '-E' . sprintf('%02d', intval($comment_record->id)) }}</h4>
                                                            </div> -->
                                                </div>
                                            </div>
                                        </div>
